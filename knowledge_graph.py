...
txt = """
The two principles of justice according to Rawls' theory are:

1) First Principle: Each person has the same indefeasible claim to a fully adequate scheme of equal basic liberties, which scheme is compatible with the same scheme of liberties for all. Examples include freedom of thought, freedom of speech, and the right to vote.

2) Second Principle: Social and economic inequalities in the distribution of primary goods (such as health, income, mobility, the social bases of self-respect, etc.) are to satisfy two conditions:
...
entity_relations = knowledge_graph.inference(txt)
print({"knowledge graph":entity_relations})